...
const PAGES = {
  summary: 3, s1: 4, s13: 4, s2: 5, s3: 7, s4: 8, s5: 9, s52: 9, s53: 10, s6: 12,
...
children.push(
  ...
  P("위 수치는 본 제안서의 그림 2~5를 생성한 실행 기준이다. 합성 코호트를 재생성하면 AUPRC는 XGBoost 0.77~0.97, NEWS 0.42~0.63 범위에서 변동한다.", { size: 18, color: MUTED, before: 100, after: 120 }),
  P([
  ...
  ...FIG("vitals_pr_curve.png", 0.855, "그림 2. PR 곡선 비교 — ROC로는 보이지 않는 격차가 정밀도–재현율 평면에서 드러난다", 360),
  ...FIG("vitals_alarm_burden.png", 0.712, "그림 3. 동일 검출률에서의 알람 부담 — 고민감도 구간에서 NEWS의 알람이 급증한다", 420),
  ...FIG("vitals_trajectory.png", 0.544, "그림 4. 환자 악화 궤적과 경보 시점 — 위험도 상승이 사건에 선행한다", 510),
  ...FIG("vitals_lead_time.png", 0.711, "그림 5. lead-time 분포 — 개입 가능 시간의 확보 정도", 415),
);
...
children.push(
  ...
  ...FIG("vitals_phenotypes.png", 0.442, "그림 6. 심정지 표현형 군집 — 기저선 대비 변화량 기준 아형 분리", 545),
...
children.push(
  ...
  ...FIG("dashboard_screenshot.png", 0.656, "그림 7. 구현·배포된 조기경보 화면 — 위험도 추이, 활력징후, 기여 요인, 알람 부담을 한 화면에 제시", 545),
